...
<body>
	...
	<div id="main" style="height:525px">
		<div id="book">
			<div class="book_cond">
			...
			<div style="text-align: center">
				...
				<c:if test="${empty sessionScope.cart.cartItems}">
					<span style="color: red">亲，当前购物车为空，快快选购吧！</span>
				</c:if>
...
<script type="text/javascript">
	$(function() {
		$("button.addToCart").click(function() {
			...
			location.href = "http://" + location.host + "/bookstore/cartServlet?action=addItem&id=" + bookId
